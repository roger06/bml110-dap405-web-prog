...
<!-- Code to format payslip and include data from JSON file -->

<body>
        <div id="content">

                <?php
                $emp = $employees[$_GET['id']];
        ...
        <!-- Button to return to previous page - employee data table -->
        <div class="btn-group">
                <a href="table.php" class="btn btn-sm btn-outline-secondary">Back to Employee Data</a>
        </div>
