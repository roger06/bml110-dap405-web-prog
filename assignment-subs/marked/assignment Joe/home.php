<html lang="en">
  ...
  <body>
    ...
    <!-- Header End -->
    <div class="container">
        <form class ="sort_container" action="home.php">
            <p1>Sort by:</p1>
            ...
            <input type="radio" id="Ascending" name="AorD" value="Ascending" required>
            <label for="Ascending">Ascending</label><br>
            <input type="radio" id="Descending" name="AorD" value="Descending" required>
        ...
        <?php
            ...
            if(isset($_GET['sort_list'])){
                ...
                $sort_filter = $_GET['sort_list'];
                $AorD = $_GET['AorD'];
                $employee_json = sortArray($employee_json, $sort_filter, $AorD);
            }
